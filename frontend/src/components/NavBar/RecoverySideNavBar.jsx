      ...
      <nav className="mt-8">
        <ul className="space-y-5 font-bold text-xl text-center">
          ...
          <li className="px-4 py-3 hover:bg-gray-700 hover:duration-300">
            <SideNavLinks linkName="RECOVERY DASHBOARD" url="/Recovery_dashboard" className=""/>
          </li>
          <li className="px-4 py-3 hover:bg-gray-700 hover:duration-300">
            <SideNavLinks linkName="PENDING" url="/Pending"/>
          </li>
          <li className="px-4 py-3 hover:bg-gray-700 hover:duration-300">
            <SideNavLinks linkName="ONGOING" url="/Ongoing"/>
          </li>
          <li className="px-4 py-3 hover:bg-gray-700 hover:duration-300">
            <SideNavLinks linkName="COMPLETED" url="/Completed"/>
          </li>
          <li className="px-4 py-3 hover:bg-gray-700 hover:duration-300">
