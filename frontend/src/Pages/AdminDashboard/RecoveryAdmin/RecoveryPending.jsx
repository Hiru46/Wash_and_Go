...
const PendingRequests = () => {
  ...
  const requests = [
    { id: 1, userId: 6465, userName: 'Alex Noman', userImg: 'https://via.placeholder.com/150' },
    { id: 2, userId: 6465, userName: 'Alex Noman', userImg: 'https://via.placeholder.com/150' },
    { id: 3, userId: 5665, userName: 'Razib Rahman', userImg: 'https://via.placeholder.com/150' },
    { id: 4, userId: 1755, userName: 'Luke Norton', userImg: 'https://via.placeholder.com/150' },
  ];
              ...
              {requests.map((request, index) => (
                <tr key={request.id} className="border-t border-gray-300">
                  ...
                  <td className="py-3 px-4 flex items-center">
                    <img src={request.userImg} alt={request.userName} className="h-8 w-8 rounded-full mr-3" />
                    {request.userName}
                  </td>
